...
website: https://chatrlab.ucdavis.edu/
alumni: false
layout: single
...
<div class="profile-card-page">
  ...
  <div class="pcp-header">
    <div class="pcp-avatar-wrap">
      <img src="/images/lab/jingwenzhang.jpg" alt="Jingwen Zhang" class="pcp-avatar" />
    </div>
    <div class="pcp-meta">
      ...
      <div class="pcp-links">
        <a href="https://scholar.google.com/citations?user=J8oKsuIAAAAJ&hl=en" target="_blank" rel="noopener">
          <i class="fas fa-fw fa-graduation-cap" aria-hidden="true"></i> Google Scholar
        </a>
        <a href="https://chatrlab.ucdavis.edu/" target="_blank" rel="noopener">
