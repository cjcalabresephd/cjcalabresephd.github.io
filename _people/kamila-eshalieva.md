...
<div class="profile-card-page">
  ...
  <div class="pcp-header">
    <div class="pcp-avatar-wrap">
      <img src="/images/lab/kamilaeshalieva.jpg" alt="Kamila Eshalieva" class="pcp-avatar" />
    </div>
    <div class="pcp-meta">
      ...
      <div class="pcp-links">
        <a href="https://www.linkedin.com/in/kamila-eshalieva/" target="_blank" rel="noopener">
...
<span class="chip chip-yellow"><i class="fas fa-award" style="color: #d4a017;"></i>2026 iGRADS 2nd Place for the College of Behavioral, Social and Health Sciences, Clemson University</span>
  ...
  <div class="pcp-section">
    ...
    <div class="research-chips">
      <span class="chip chip-orange">Gender-based violence</span>
      <span class="chip chip-purple">Persuasion</span>
      <span class="chip chip-blue">Message effects</span>
    </div>
  </div>
